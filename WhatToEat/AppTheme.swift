...
struct AppTheme {
    ...
    struct Colors {
        ...
        static let profileDashboardCardSurface = Color.adaptiveHex(light: "#FFFFFF", dark: "#101D31")
        static let profileDashboardCardSecondarySurface = Color.adaptiveHex(light: "#F3F5F6", dark: "#223149")
        static let profileDashboardCardStroke = Color.adaptiveHex(light: "#FFFFFF", dark: "#2C3A50").opacity(0.88)
        static let profileDashboardCardShadow = Color.black.opacity(0.28)
